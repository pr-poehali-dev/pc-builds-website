...
const builds = [
  {
    ...
    links: [
      { label: "Ryzen 5 5600 на DNS", url: "https://www.dns-shop.ru/catalog/17a8a01d16404e77/processory/" },
      { label: "RX 6600 на Citilink", url: "https://www.citilink.ru/catalog/videokarty/" },
      { label: "Системные блоки на М.Видео", url: "https://www.mvideo.ru/computers/sistemnye-bloki" },
    ],
  },
  {
    id: "mid",
    ...
    reviews: [
      { author: "Николай", stars: 5, text: "RTX 4070 — просто зверь. Cyberpunk на 1440p в 80+ fps с трассировкой лучей — выглядит потрясающе. Сборка окупила себя за первый месяц." },
      { author: "Светлана", stars: 5, text: "Купила для видеомонтажа. Premiere Pro рендерит в 3 раза быстрее, чем на ноутбуке. Очень довольна." },
      { author: "Игорь", stars: 4, text: "i5-13600K в паре с DDR5 — очень быстрый старт системы и загрузка игр. Единственный минус — цена, но за качество платишь." },
    ],
    links: [
      { label: "i5-13600K на DNS", url: "https://www.dns-shop.ru/catalog/17a8a01d16404e77/processory/" },
      { label: "RTX 4070 на Citilink", url: "https://www.citilink.ru/catalog/videokarty/" },
      { label: "Сборки на i5 — Regard", url: "https://www.regard.ru/catalog/group4000/section6018.htm" },
    ],
  },
  {
    id: "high",
    ...
    links: [
      { label: "Ryzen 9 7950X на DNS", url: "https://www.dns-shop.ru/catalog/17a8a01d16404e77/processory/" },
      { label: "RTX 4090 на Citilink", url: "https://www.citilink.ru/catalog/videokarty/" },
      { label: "Флагманские сборки — Regard", url: "https://www.regard.ru/catalog/group4000.htm" },
    ],
  },
];
